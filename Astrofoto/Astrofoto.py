...
PROGRAM_CESTA = "/home/dpv/j44softapps-socketcontrol/Astrofoto.py"
SSH_USER = "dpv"
SSH_PASS = "otj0711"
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Ovládanie Hvezdárne - ASTROFOTO")
    ...
    def init_astrofoto_section(self):
        ...
        self.sever_button.clicked.connect(lambda: self.ovladaj_strechu("zapad"))
        self.juh_button.clicked.connect(lambda: self.ovladaj_strechu("vychod"))
        ...
        self.cas_smer.addItems(["zapad", "vychod", "both"])
    ...
    def init_ota_section(self):
        ...
        for r, (txt, url) in enumerate([
            ("Kamera astrofoto", "http://172.20.20.134"),
    ...
    def ovladaj_strechu(self, s):
        if s == "sever":
            p1, p2 = "pyhid-usb-relay on 1 && sleep 2 && pyhid-usb-relay off 1"
        elif s == "juh":
            p1, p2 = "pyhid-usb-relay on 2 && sleep 2 && pyhid-usb-relay off 2"
        elif s == "both":
            p1, p2 = "pyhid-usb-relay on 1 && sleep 1 && pyhid-usb-relay on 2 && sleep 2 && pyhid-usb-relay off 1 && sleep 1 && pyhid-usb-relay off 2"
        else:
            return
        try:
